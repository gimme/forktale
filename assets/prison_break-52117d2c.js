...
options:
  ...
  - action: Close the gate.
    result:
      Choose 2 survivors you control. Roll for exposure twice on each of the
      chosen survivors. Nothing else happens.
  - action: Take the opportunity to go after the riot gear and then close the gate.
    result:
      Choose 2 survivors you control. Roll for exposure 4 times on each of the
