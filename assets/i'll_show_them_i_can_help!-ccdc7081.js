const e=`title: I'LL SHOW THEM I CAN HELP!
...
options:
  ...
  - action:
      If the colony votes for the thumbs down option, any player may choose to
      have this option trigger instead. "Monsters! I'll not leave her to die out
      there."
    result:
      The player that chose to trigger this option must remove a survivor they
